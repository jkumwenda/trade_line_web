            ...
            <div className="flex sm:flex-row flex-col">
              <div className="w-9/12 p-4 bg-concrete-50 rounded-xl">
                <div id="accordion-open" data-accordion="open">
                  ...
                  >
                    <div class="p-5 font-light border border-b-0 border-concrete-600 dark:border-gray-700 dark:bg-gray-900">
                  ...
                  <h2 id="accordion-open-heading-2">
                    <button
                      type="button"
                      class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-concrete-600 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                  ...
                  >
                    <div class="p-5 font-light border border-b-0 border-concrete-600 dark:border-gray-700">
                      <p class="mb-2 text-gray-500 dark:text-gray-400">
                  ...
                  <h2 id="accordion-open-heading-3">
                    <button
                      type="button"
                      class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-concrete-600 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                  ...
                  >
                    <div class="p-5 font-light border border-t-0 border-concrete-600 dark:border-gray-700">
                      <p class="mb-2 text-gray-500 dark:text-gray-400">
